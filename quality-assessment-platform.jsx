  ...
  return (
    <aside className="qa-sidebar">
      <div className="qa-brand">
        <img src="/evergauge-logo-white-v2.png?v=4" alt="EverGauge" className="qa-brand-logo" />
      ...
      <div className="qa-land-shell">
        <section className="qa-land-hero">
          <div className="qa-land-brand">
            <img src="/evergauge-logo-white-v2.png?v=4" alt="EverGauge" className="qa-land-logo" />
          </div>
